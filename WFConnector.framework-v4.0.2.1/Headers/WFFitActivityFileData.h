...
@interface WFFitActivityFileData : NSObject
{
    ...
    NSMutableArray* __weak sessionRecords;
    NSMutableArray* __weak lapRecords;
	NSMutableArray* __weak dataRecords;
    NSMutableArray* __weak eventRecords;
    NSMutableArray* __weak workoutRecords;
	NSMutableArray* __weak activityRecords;
 ...
 * about the file.
 */
@property (nonatomic, strong) WFFitMesgFileId* fileId;

/**
 * Gets the device info for the device which created the FIT file.
 */
@property (nonatomic, strong) WFFitMessageDeviceInfo* deviceInfo;

/**
 * Gets a collection of WFFitSessionRecord instances for the file.
 */
@property (weak, nonatomic, readonly) NSArray* sessionRecords;

/**
 * Gets a collection of WFFitLapRecord instances for the file.
 */
@property (weak, nonatomic, readonly) NSArray* lapRecords;

/**
 * Gets a collection of WFFitDataRecord instances for the file.
 */
@property (weak, nonatomic, readonly) NSArray* dataRecords;

/**
 * Gets a collection of WFFitEventRecord instances for the file.
 */
@property (weak, nonatomic, readonly) NSArray* eventRecords;

/**
 * Gets a collection of WFFitWorkoutRecord instances for the file.
 */
@property (weak, nonatomic, readonly) NSArray* workoutRecords;

/**
 * Gets a collection of WFFitActivityRecord instances for the file.
 */
@property (weak, nonatomic, readonly) NSArray* activityRecords;
