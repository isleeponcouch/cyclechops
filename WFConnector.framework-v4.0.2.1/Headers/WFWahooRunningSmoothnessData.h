...
@property (nonatomic, retain) NSNumber *runningSmoothnessX;         /**< A measure of running smoothness along the x-axis (side-to-side).*/
@property (nonatomic, retain) NSNumber *runningSmoothnessY;         /**< A measure of running smoothness along the y-axis (up-down).*/
@property (nonatomic, retain) NSNumber *runningSmoothnessZ;         /**< A measure of running smoothness along the z-axis (forward-backward).*/
