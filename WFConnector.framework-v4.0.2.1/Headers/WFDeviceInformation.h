 ...
 */
@interface WFDeviceInformation : NSObject<NSCoding>
{
    NSDate* _lastUpdate;
    NSUUID* UUID;
    ...
    NSString* productKey;
    NSSet* capabilities;
    NSSet* advancedAdvertisingFlags;
 ...
 */
@property (nonatomic, strong, readonly) NSArray* supportedSensorTypes;
...
/**
 * Product Capability keys. This is for Wahoo Fitness products and selected 3rd parties.
 */
@property (nonatomic, strong, readonly) NSSet* capabilities;

/**
 * Advanced Advertising Flags. This is for Wahoo Fitness products and selected 3rd parties.
 */
@property (nonatomic, strong, readonly) NSSet* advancedAdvertisingFlags;
...
extern NSString * const WFProductKeyWahooFitnessTICKRFit;
extern NSString * const WFProductKeyWahooFitnessKICKR;
extern NSString * const WFProductKeyWahooFitnessKICKRSnap;
extern NSString * const WFProductKeyWahooFitnessKICKRCore;
extern NSString * const WFProductKeyWahooFitnessKICKRBike;
extern NSString * const WFProductKeyWahooFitnessHeadwind;
...
extern NSString * const WFProductKeyWahooFitnessELEMNT;
extern NSString * const WFProductKeyWahooFitnessELEMNTMINI;
extern NSString * const WFProductKeyWahooFitnessELEMNTMIDI;
extern NSString * const WFProductKeyWahooFitnessELEMNTRIVAL;
extern NSString * const WFProductKeyWahooFitnessELEMNTROAM;
extern NSString * const WFProductKeyWahooFitnessKICKRCLIMB;
extern NSString * const WFProductKeyWahooFitnessGymConnect;
extern NSString * const WFProductKeyWahooFitnessGymConnectTreadmill;
extern NSString * const WFProductKeyWahooFitnessGymConnectBike;
extern NSString * const WFProductKeyWahooFitnessGymConnectStepper;
extern NSString * const WFProductKeyWahooFitnessGymConnectStepMill;
extern NSString * const WFProductKeyWahooFitnessGymConnectCrossTrainer;
extern NSString * const WFProductKeyWahooFitnessGymConnectTotalBodyTrainer;
extern NSString * const WFProductKeyWahooFitnessGymConnectTreadClimber;
extern NSString * const WFProductKeyWahooFitnessGymConnectRower;
...
extern NSString * const WFProductKeyGenericGearSelection;
extern NSString * const WFProductKeyGenericPowerMeterPedal;
extern NSString * const WFProductKeyGenericPowerMeterCrank;
extern NSString * const WFProductKeyGenericPowerMeterHub;
extern NSString * const WFProductKeyGenericBikeRadar;

extern NSString * const WFProductKeyPowerTapP1Right;
extern NSString * const WFProductKeyPowerTapP1Left;
extern NSString * const WFProductKeyP2INpower;
extern NSString * const WFProductKeyPower2MaxNG;
extern NSString * const WFProductKeyTyrePressure;



/**
 * Defined contants of Product Capability Keys
 * @see WFDeviceInformation::capabilities
 */
extern NSString * const WFProductCapabilityKeyStaticQRCodeAdvertisingID;
extern NSString * const WFProductCapabilityKeyReportsAdvertisingSolicitedStatus;


/**
 * Defined contants of Advanced Advertising Flag Keys
 * @see WFDeviceInformation::advancedAdvertisingFlags
 */
extern NSString * const WFAdvancedAdvertisingFlagKeyAdvertisingSolicited;
