...
@property (nonatomic, strong) WFFitMesgFileId* fileIdMesg;
/** Gets the Device settings data. */
@property (nonatomic, strong) WFFitMesgDeviceSettings* deviceSettingsMesg;
/** User profile data. */
@property (nonatomic, strong) WFFitMesgUserProfile* userProfileMesg;
/** Gets the Heart rate monitor profile data. */
@property (nonatomic, strong) WFFitMesgHRMProfile* hrmProfileMesg;
