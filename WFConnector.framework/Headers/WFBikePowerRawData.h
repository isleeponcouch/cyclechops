 ...
 */
@property (nonatomic, strong) WFBikePowerPowerOnlyData* powerOnlyData;
/**
 * Data provided by the Wheel-Torque type of Bike Power sensor.
 */
@property (nonatomic, strong) WFBikePowerWheelTorqueData* wheelTorqueData;
/**
 * Data provided by the Crank-Torque type of Bike Power sensor.
 */
@property (nonatomic, strong) WFBikePowerCrankTorqueData* crankTorqueData;
/**
 * Data provided by the Crank-Torque-Frequency type of Bike Power sensor.
 */
@property (nonatomic, strong) WFBikePowerCTFData* crankTorqueFreqData;
