 ...
 */
@property (nonatomic, strong) WFDeviceParams* device1;

/**
 * The second of four possible devices to connect.
 */
@property (nonatomic, strong) WFDeviceParams* device2;

/**
 * The third or four possible devices to connect.
 */
@property (nonatomic, strong) WFDeviceParams* device3;

/**
 * The fourth of four possible devices to connect.
 */
@property (nonatomic, strong) WFDeviceParams* device4;
 ...
 * @note This property is for internal use, and should not be assigned directly.
 */
@property (nonatomic, strong) NSData* conditionalData;
