...
@interface WFDiscoveryManager : NSObject
{
    ...
    id<WFDiscoveryManagerDelegate> __weak delegate;
    NSMutableArray* mutableDiscoveredDevices;
}


@property (nonatomic, weak) id<WFDiscoveryManagerDelegate> delegate;
...
/**
 * Cancels device discovery on the specified network and disconnects sensors.
 *
 */
