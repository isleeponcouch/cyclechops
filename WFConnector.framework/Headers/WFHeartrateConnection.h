...
{
    id<WFHeartrateConnectionTICKRXDelegate> __weak heartrateConnectionTICKRXDelegate;
    id<WFHeartrateConnectionTICKRXSpeedProvider> __weak motionAnalysisProcessingSpeedProvider;
    id<WFWahooActivitySessionManagementDelegate> __weak activitySessionManagementDelegate;
}
